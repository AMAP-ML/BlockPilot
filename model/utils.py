...
def load_and_process_dataset(data_name: str):
    ...
    # Coding datasets
        ...
        LBPP_PY_TEST_URL = "https://hf-mirror.com/datasets/CohereLabs/lbpp/resolve/main/python/test.parquet"
        ...
        base = "https://hf-mirror.com/datasets/livecodebench/code_generation_lite/resolve/main/"
...
def load_txt_dataset(file_path: str):
    """
     TXT ，。
    ， {"turns": [sentence]} ，。
    """
